...
entity_builders = (
    ...
    (EntityKinds.FUNCTION_VLLMSERVEPOOLING.value, FunctionVllmservepoolingBuilder),
    ...
    (EntityKinds.RUN_VLLMSERVEPOOLING_SERVE.value, RunVllmservepoolingRunBuilder),
    ...
    (EntityKinds.TASK_VLLMSERVEPOOLING_SERVE.value, TaskVllmservepoolingServeBuilder),
